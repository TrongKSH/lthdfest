...
• Truong Kim Trong - drummer",
         ...
         new Band
        {
            Id = 2,
            Name = "Morning Wait",
            Bio = @"Morning Wait là ban nhạc đến từ Việt Nam. Dự án theo đuổi tinh thần mạnh mẽ của nhạc nặng với năng lượng biểu diễn trực diện và hiện đại.

Ban nhạc tập trung vào sáng tác, biểu diễn live và mở rộng cộng đồng khán giả yêu nhạc nặng tại Việt Nam.",
            BioEn = "Morning Wait is a Vietnamese band. The project follows an intense heavy-music spirit with direct, modern live energy. The band focuses on songwriting, live shows, and growing Vietnam's heavy-music audience.",
